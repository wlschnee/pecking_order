...
@treats = Event.create(name: "Frozen Treats", host_id: 3, location_id: 2, start_time: Time.parse("#{DateTime.current + 2}"), meeting_place: "The Wall", duration: "🐰")
@bros = Event.create(name: "Bros Lunch", host_id: 4, location_id: 3, start_time: Time.parse("#{DateTime.current + 0.9}"), meeting_place: "Castle Black", duration: "🐢")
@burgers = Event.create(name: "Burgers!!", host_id: 7, location_id: 4, start_time: Time.parse("#{DateTime.current + 0.8}"), meeting_place: "A weird temple", duration: "🐼")
@feast = Event.create(name: "Feasting", host_id: 2, location_id: 5, start_time: Time.parse("#{DateTime.current + 1}"), meeting_place: "Dany's pyramid", duration: "🐼")
@ramen = Event.create(name: "Ramen", host_id: 5, location_id: 6, start_time: Time.parse("#{DateTime.current + 1}"), meeting_place: "Winterfell", duration: "🐢")
@hotdogs = Event.create(name: "Not Hotdogs", host_id: 18, location_id: 7, start_time: Time.parse("#{DateTime.current + 1}"), meeting_place: "Iron Islands", duration: "🐰")
@bbq = Event.create(name: "Texas BBQ", host_id: 11, location_id: 8, start_time: Time.parse("#{DateTime.current + 1}"), meeting_place: "The woods?", duration: "🐼")
...
Friendship.create(user_id: @tl.id, friend_id: @dt.id)
...
Friendship.create(user_id: @js.id, friend_id: @tl.id)
Friendship.create(user_id: @js.id, friend_id: @bs.id)
...
Friendship.create(user_id: @ss.id, friend_id: @js.id)
Friendship.create(user_id: @ss.id, friend_id: @bs.id)
...
Friendship.create(user_id: @st.id, friend_id: @js.id)
Friendship.create(user_id: @st.id, friend_id: @bs.id)
Friendship.create(user_id: @st.id, friend_id: @ds.id)

Friendship.create(user_id: @st.id, friend_id: @js.id)
Friendship.create(user_id: @st.id, friend_id: @bs.id)
Friendship.create(user_id: @st.id, friend_id: @ss.id)
Friendship.create(user_id: @st.id, friend_id: @jh.id)
Friendship.create(user_id: @st.id, friend_id: @bt.id)

Friendship.create(user_id: @cl.id, friend_id: @jl.id)
Friendship.create(user_id: @cl.id, friend_id: @tl.id)
...
Friendship.create(user_id: @jm.id, friend_id: @dt.id)
Friendship.create(user_id: @jm.id, friend_id: @gw.id)
Friendship.create(user_id: @jm.id, friend_id: @tl.id)

Friendship.create(user_id: @ds.id, friend_id: @js.id)
Friendship.create(user_id: @ds.id, friend_id: @st.id)
Friendship.create(user_id: @ds.id, friend_id: @tg.id)
Friendship.create(user_id: @ds.id, friend_id: @ss.id)
Friendship.create(user_id: @ds.id, friend_id: @bt.id)

Friendship.create(user_id: @bt.id, friend_id: @ss.id)
Friendship.create(user_id: @bt.id, friend_id: @as.id)
Friendship.create(user_id: @bt.id, friend_id: @js.id)
Friendship.create(user_id: @bt.id, friend_id: @jl.id)
Friendship.create(user_id: @bt.id, friend_id: @tg.id)
Friendship.create(user_id: @bt.id, friend_id: @ds.id)

Friendship.create(user_id: @tg.id, friend_id: @js.id)
Friendship.create(user_id: @tg.id, friend_id: @bt.id)
Friendship.create(user_id: @tg.id, friend_id: @st.id)
Friendship.create(user_id: @tg.id, friend_id: @ds.id)

Friendship.create(user_id: @jl.id, friend_id: @cl.id)
Friendship.create(user_id: @jl.id, friend_id: @tl.id)
Friendship.create(user_id: @jl.id, friend_id: @bt.id)
Friendship.create(user_id: @jl.id, friend_id: @pb.id)
Friendship.create(user_id: @jl.id, friend_id: @vs.id)

Friendship.create(user_id: @pb.id, friend_id: @ss.id)
Friendship.create(user_id: @pb.id, friend_id: @cl.id)
Friendship.create(user_id: @pb.id, friend_id: @jl.id)
Friendship.create(user_id: @pb.id, friend_id: @tl.id)
Friendship.create(user_id: @pb.id, friend_id: @vs.id)

Friendship.create(user_id: @gw.id, friend_id: @dt.id)
Friendship.create(user_id: @gw.id, friend_id: @tl.id)
Friendship.create(user_id: @gw.id, friend_id: @vs.id)
Friendship.create(user_id: @gw.id, friend_id: @jm.id)

Friendship.create(user_id: @ww.id, friend_id: @bs.id)

Friendship.create(user_id: @jh.id, friend_id: @as.id)

Friendship.create(user_id: @mt.id, friend_id: @cl.id)

Friendship.create(user_id: @vs.id, friend_id: @tl.id)
Friendship.create(user_id: @vs.id, friend_id: @cl.id)
Friendship.create(user_id: @vs.id, friend_id: @jl.id)
Friendship.create(user_id: @vs.id, friend_id: @pb.id)
Friendship.create(user_id: @vs.id, friend_id: @dt.id)
Friendship.create(user_id: @vs.id, friend_id: @jm.id)
